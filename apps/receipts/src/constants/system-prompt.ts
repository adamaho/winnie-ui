...
- date: the date the purchase was made, MUST be formatted as YYYY-MM-DD. DO NOT FUCK THIS UP! Make sure to take into account that all dates will be formatted differently on the receipts. Some will be MM/DD/YYYY, others will be YY/MM/DD. So be sure to parse the date into the correct format. All receipts will be in the year 2025 or future. So don't give me something that is in a year less than 2025.

- transation: object representing the details of the transaction

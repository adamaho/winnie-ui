...
import { RadiusExample } from "./_components/radius-example.tsx";
...
```tsx title="root.tsx" ins="class="winnie-ui"" ins="data-radius="2""
export default function Root() {
  return (
    <html>
      <head></head>
      <body class="winnie-ui" data-radius="2">
        <App />
      </body>
    </html>
  );
...
<Demo>
  <RadiusExample client:only="react" />
</Demo>

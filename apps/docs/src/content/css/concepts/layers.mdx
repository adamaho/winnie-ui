...
The spatial layer is reserved for styles that pertain to design system components like buttons, selects and inputs that only have layout relatived styles applied. For more information on how to use spatial styles, see the components [Introduction](/css/docs/components/introduction).

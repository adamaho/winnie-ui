...
Before you get started, install and configure [Tailwind](https://tailwindcss.com/docs/installation) and [Winnie CSS](/css/docs/start/quick-start) in your application.
...
Winnie CSS makes use of a new Tailwind feature in V4 which allows you to define a custom Tailwind theme using CSS. For more information see [Theme Variables](https://tailwindcss.com/docs/theme#what-are-theme-variables).

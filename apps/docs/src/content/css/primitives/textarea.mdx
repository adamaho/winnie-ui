...
| ---------- | ----------------------------------------------------- |
| `hovered`  | When the textarea is hovered with a mouse             |
| `pressed`  | When the textarea is pressed with a mouse or keyboard |
| `disabled` | When the textarea prevents user interaction           |
| `invalid`  | When the textarea is in an invalid state in a form    |
